...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile mojocoin.pro
#############################################################################
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /home/parallels/repo/mojo-final/src/leveldb/libleveldb.a /home/parallels/repo/mojo-final/src/leveldb/libmemenv.a /home/parallels/repo/mojo-final/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -lz -ldb_cxx -lgmp -levent -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5DBus -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
