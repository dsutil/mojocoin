    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("MojoMixed"), TransactionFilterProxy::TYPE(TransactionRecord::MojoMixed));
    typeWidget->addItem(tr("MojoMix Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendMakeCollaterals));
    typeWidget->addItem(tr("MojoMix Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendCreateDenominations));
    typeWidget->addItem(tr("MojoMix Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendDenominate));
    typeWidget->addItem(tr("MojoMix Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendCollateralPayment));
