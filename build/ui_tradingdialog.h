...
public:
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        gridLayout_6->addWidget(TXSupply, 0, 10, 1, 2);

        BidsCount = new QLabel(BuyTab);
        BidsCount->setObjectName(QStringLiteral("BidsCount"));

        gridLayout_6->addWidget(BidsCount, 1, 0, 1, 2);
        ...
        gridLayout_6->addWidget(BtcDemand, 1, 5, 1, 1);

        AsksCount = new QLabel(BuyTab);
        AsksCount->setObjectName(QStringLiteral("AsksCount"));

        gridLayout_6->addWidget(AsksCount, 1, 7, 1, 1);
        ...
        gridLayout_6->addWidget(BtcSupply, 1, 11, 1, 1);

        BidsTable = new QTableWidget(BuyTab);
        BidsTable->setObjectName(QStringLiteral("BidsTable"));
        BidsTable->setMinimumSize(QSize(481, 0));
        QFont font3;
        font3.setPointSize(9);
        font3.setBold(false);
        font3.setWeight(50);
        BidsTable->setFont(font3);
        ...
        AsksTable->setMinimumSize(QSize(481, 0));
        AsksTable->setFont(font3);

        gridLayout_6->addWidget(AsksTable, 2, 7, 1, 5);

        horizontalSpacer_5 = new QSpacerItem(28, 138, QSizePolicy::Preferred, QSizePolicy::Minimum);

        gridLayout_6->addItem(horizontalSpacer_5, 3, 0, 5, 1);
        ...
        label232->setFont(font4);

        horizontalLayout_3->addWidget(label232);

        BtcAvailableLbl = new QLabel(BuyTab);
        ...
        BtcAvailableLbl->setPalette(palette);
        BtcAvailableLbl->setFont(font4);
        ...
        BtcAvailableLbl_2 = new QLabel(BuyTab);
        BtcAvailableLbl_2->setObjectName(QStringLiteral("BtcAvailableLbl_2"));
        BtcAvailableLbl_2->setFont(font4);
        ...
        horizontalSpacer = new QSpacerItem(188, 138, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout_6->addItem(horizontalSpacer, 3, 5, 5, 3);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        label232_2 = new QLabel(BuyTab);
        label232_2->setObjectName(QStringLiteral("label232_2"));
        label232_2->setFont(font4);
        ...
        TXAvailableLabel->setFont(font4);
        ...
        horizontalSpacer_2 = new QSpacerItem(98, 138, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout_6->addItem(horizontalSpacer_2, 3, 11, 5, 1);
        ...
        UnitsInput->setMinimumSize(QSize(137, 0));
        QFont font6;
        font6.setPointSize(9);
        font6.setBold(true);
        font6.setWeight(75);
        UnitsInput->setFont(font6);
        ...
        UnitsInputTX->setMinimumSize(QSize(137, 0));
        UnitsInputTX->setFont(font6);
        ...
        BuyBidPriceEdit->setMinimumSize(QSize(137, 0));
        BuyBidPriceEdit->setFont(font6);
        ...
        SellBidPriceEdit->setMinimumSize(QSize(137, 0));
        SellBidPriceEdit->setFont(font6);
        ...
        font7.setBold(true);
        font7.setWeight(75);
        label232_4->setFont(font7);
        label232_4->setAlignment(Qt::AlignCenter);

        gridLayout_7->addWidget(label232_4, 0, 0, 1, 4);

        horizontalSpacer_7 = new QSpacerItem(82, 358, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_7->addItem(horizontalSpacer_7, 0, 4, 12, 1);
        ...
        gridLayout_7->addWidget(label232_15, 0, 5, 12, 1);

        horizontalSpacer_6 = new QSpacerItem(212, 368, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_7->addItem(horizontalSpacer_6, 0, 6, 12, 1);
        ...
        BittrexBTCLabel->setPalette(palette4);
        BittrexBTCLabel->setFont(font9);
        ...
        gridLayout_7->addLayout(horizontalLayout_10, 2, 0, 1, 4);
        ...
        BittrexTXLabel->setPalette(palette5);
        BittrexTXLabel->setFont(font9);
        ...
        gridLayout_7->addLayout(horizontalLayout_8, 3, 0, 1, 4);
        ...
        CSUnitsAddress->setFont(font9);

        gridLayout_7->addWidget(CSUnitsAddress, 5, 2, 1, 2);
        ...
        CSDumpLabel->setPalette(palette6);
        CSDumpLabel->setFont(font9);
        ...
        gridLayout_7->addLayout(horizontalLayout_7, 6, 0, 1, 4);
        ...
        CSTotalLabel->setPalette(palette7);
        CSTotalLabel->setFont(font9);
        ...
        gridLayout_7->addLayout(horizontalLayout_6, 7, 0, 1, 4);
        ...
        CSReceiveLabel->setPalette(palette8);
        CSReceiveLabel->setFont(font9);
        ...
        gridLayout_7->addLayout(horizontalLayout_9, 8, 0, 1, 4);
        ...
        verticalSpacer_4 = new QSpacerItem(338, 145, QSizePolicy::Minimum, QSizePolicy::MinimumExpanding);

        gridLayout_7->addItem(verticalSpacer_4, 11, 0, 2, 4);

        verticalSpacer_3 = new QSpacerItem(915, 73, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_7->addItem(verticalSpacer_3, 12, 1, 1, 6);
        ...
        gridLayout_2->addWidget(BitcoinBalanceLabel, 0, 6, 1, 1);
        ...
        gridLayout_2->addWidget(BitcoinAvailableLabel, 1, 6, 1, 1);
        ...
        gridLayout_2->addWidget(BitcoinPendingLabel, 2, 6, 1, 1);
        ...
        gridLayout_2->addWidget(GenDepositBTN, 3, 0, 1, 7);
        ...
        DepositAddressLabel->setMinimumSize(QSize(311, 0));
        QPalette palette9;
        ...
        DepositAddressLabel->setFont(font9);
        ...
        gridLayout_2->addWidget(DepositAddressLabel, 4, 3, 1, 4);
        ...
        gridLayout_2->addWidget(Withdraw_Max_Amount, 6, 1, 1, 3);

        WithdrawUnitsInput = new QLineEdit(BalanceTab);
        WithdrawUnitsInput->setObjectName(QStringLiteral("WithdrawUnitsInput"));
        WithdrawUnitsInput->setFont(font6);

        gridLayout_2->addWidget(WithdrawUnitsInput, 6, 4, 1, 2);
        ...
        WithdrawAddress->setFont(font6);

        gridLayout_2->addWidget(WithdrawAddress, 7, 1, 1, 6);
        ...
        gridLayout_2->addWidget(WithdrawUnitsBtn, 8, 2, 1, 3);

        verticalSpacer = new QSpacerItem(428, 262, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_2->addItem(verticalSpacer, 9, 0, 1, 7);
        ...
        gridLayout->addWidget(label232_16, 4, 0, 1, 2);
        ...
        gridLayout->addWidget(label232_17, 4, 2, 1, 3);
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        TXDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 MOJO", 0));
        TXSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 MOJO", 0));
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "MOJO Available:", 0));
        TXAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelTX->setText(QApplication::translate("tradingDialog", " MOJO", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "MOJO", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "MOJO", 0));
        ...
        BuyTX->setText(QApplication::translate("tradingDialog", "Buy MOJO", 0));
        SellTXBTN->setText(QApplication::translate("tradingDialog", "Sell MOJO", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "MOJO Balance:", 0));
        BittrexTXLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "MOJO", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in MOJO:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "MOJO", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "MOJO Balance:", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "MOJO Available:", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "MOJO Pending:", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate MOJO Coin Deposit Address", 0));
        label_33->setText(QApplication::translate("tradingDialog", "Deposit Address:", 0));
        DepositAddressLabel->setText(QString());
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw MOJO:", 0));
