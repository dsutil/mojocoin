...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Mojocoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Mojocoin</b> version", 0));
...
"Copyright \302\251 2014 The Mojocoin developers", 0));
